...
<div class="content">
    ...
    <ul>
        ...
        <li>
            <strong>What's new with IO-500</strong> – <em>George Markomanolis</em> 
        </li>
        <li>
        ...
        <li>
            <strong>The new IO-500 list and analysis</strong> – <em>George Markomanolis, Julian Kunkel, Jay Lofstead, John Bent</em>
        </li>
        <li>
