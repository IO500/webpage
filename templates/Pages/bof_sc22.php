<?php $this->assign('title', 'Birds-of-a-Feather - SC 22'); ?>
...
<div class="content">
    ...
    <table class="tb">
        ...
        <tbody>
            <tr>
                ...
                <td>Tuesday, 15 November 2022, 5:15pm - 6:45pm CST</td>
            </tr>
            <tr>
    ...
    <p>
        <a class="link" href="https://sc22.supercomputing.org/presentation/?id=bof124&sess=sess331" target="_blank">Link to the official announcement</a>.
    </p>
    ...
    <a class="link" href="/files/SC22_IO500_Presentation.pdf" target="_blank">BOF Slides</a>
</div>
