<?php $this->assign('title', 'Birds-of-a-Feather - SC 23'); ?>
...
<nav id="breadcrumb">
    ...
    $this->Breadcrumbs->add(__("SC'23"), ['controller' => 'pages', 'action' => 'display', 'bof-sc23']);
...
<div class="content">
    ...
    <table class="tb">
        ...
        <tbody>
            <tr>
                ...
                <td>Wednesday, 15 Nov 2023, 12:15pm - 1:15pm MST</td>
            </tr>
            <tr>
                <td><strong>Venue</strong></td>
                <td>Colorado Convention Center - Room 501-502</td>
            </tr>
        </tbody>
    </table>

    <p>
        Official SC event link: <a class="link" href="https://sc23.supercomputing.org/presentation/?id=bof144&sess=sess363" target="_blank">IO500: The High-Performance Storage Community</a>.
    </p>
    ...
    <ol>
        <li>
            reveal the current IO500 lists and provide highlights and insight
        </li>
        <li>
    ...
    <!-- insert presentation link <a class="link" href="/files/SC23_IO500_Presentation.pdf" target="_blank">Slides</a> -->
</div>
