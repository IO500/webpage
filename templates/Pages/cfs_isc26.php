...
<div class="content">
    ...
    <p class="call">
        Stabilization Period: April 27th - May 12th, 2026
        <br/>
        Submission Deadline: June 12th, 2026 AoE
    </p>
    ...
    <p>
        ...
        <?php echo $this->Html->link(__('"IO500: High Performance Storage
         Community" BoF'),
            [ 'controller' => 'pages', 'action' => 'display', 'bof-isc26' ],
            [ 'class' => 'link' ]);
         ?>.
    ...
    <p>
        ...
        <?php echo $this->Html->link('ISC26 BoF',
            [ 'controller' => 'pages', 'action' => 'display', 'bof-isc26' ],
            [ 'class' => 'link' ]);
         ?>
        on ISC26, where we will announce the new IO500 Production and 
        Research lists and their 10 client node counterparts.
    </p>
    <h2>Be Part of the Community</h2>
    <p>
        Submissions of all sizes are welcome; the webpage features
        customizable sorting, allowing you to submit on a small
        system and still achieve a very good per-client score, for
